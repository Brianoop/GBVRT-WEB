...
<div class="sidepanel-inner d-flex flex-column">
    ...
    <div class="app-branding">
        <a class="app-logo" href="{{ route('dashboard.home') }}"><img class="logo-icon me-2"
                src="{{ asset('dashboard_assets/images/app-logo.svg') }}" alt="logo"><span
                class="logo-text">GBVRT</span></a>
        ...
        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
            ...
            @if (Auth::user()->type == 3)
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('report.case') }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Report Case</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('users.cases') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-folder" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('view.activists') }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">View Activists</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('send.complaint') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <span class="nav-link-text">Send Complaints</span>
                    </a>
            ...
            @elseif(Auth::user()->type == 2)
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ url('/activists-cases' . '/' . Auth()->user()->id) }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-folder" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <span class="nav-link-text">View Cases</span>
                    </a>
            ...
            @elseif(Auth::user()->type == 1)
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('manage.cases') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-folder" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('user.complaints') }}">
                        ...
                        <span class="nav-link-text">View Complaints</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('violence.types.view') }}">
                        ...
                        <span class="nav-link-text">Violences</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('subcounties.view') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <span class="nav-link-text">Sub Counties</span>
                    </a>
