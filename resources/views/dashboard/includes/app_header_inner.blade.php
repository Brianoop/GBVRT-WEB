        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="app-utilities col-auto">
                        ...
                        <div class="dropdown-menu-content">
                                ...
                                <div class="row gx-2 justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <img class="profile-image"
                                            src="{{ asset('dashboard_assets/images/profiles/profile-1.png') }}"
                                            alt="">
                                    </div>
                                    <!--//col-->
                                    <div class="col">
                            ...
                            <div class="item p-3">
                                <div class="row gx-2 justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <img class="profile-image"
                                            src="{{ asset('dashboard_assets/images/profiles/profile-2.png') }}"
                                            alt="">
                                    </div>
                                    <!--//col-->
                                    <div class="col">
                ...
                <div class="app-utility-item">
                    <a href="{{ route('user.settings') }}" title="Settings">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                ...
                <div class="app-utility-item app-user-dropdown dropdown">
                    <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                        role="button" aria-expanded="false"><img
                            src="{{ asset('dashboard_assets/images/user.png') }}" alt="user profile"></a>
