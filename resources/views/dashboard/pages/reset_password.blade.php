		    ...
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
					...
					<div class="auth-form-container text-left">
						...
						<div class="auth-option text-center pt-5"><a class="app-link" href="{{ route('login.page') }}" >Log in</a> <span class="px-2">|</span> <a class="app-link" href="{{ route('signup.page') }}" >Sign up</a></div>
