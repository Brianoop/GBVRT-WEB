	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
					...
					<h2 class="auth-heading text-center mb-4">Sign up to GBVRT</h2>	
					...
					<div class="auth-form-container text-start mx-auto">
						<form method="POST" action="{{ route('register.custom') }}" class="auth-form auth-signup-form">     
							@csrf 
							@method('POST')    
						...
						<div class="auth-option text-center pt-5">Already have an account? <a class="text-link" href="{{ route('login.page') }}" >Log in</a></div>
