...
<head>
    ...
    <meta name="description" content="GBVRT - A platform for reporting and tracking gender based violence in Uganda">
    <meta name="author" content="Saraphina Akwii">    
	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
					...
					<h2 class="auth-heading text-center mb-5">Log in to GBVRT</h2>

					@if(Session::has('success'))

					<span class="text-danger mb-2">{{ Session::get('success') }}</span>

					@endif

			        <div class="auth-form-container text-start">
						<form method="POST" action="{{ route('login.custom') }}" class="auth-form login-form">       
							@csrf 
							@method('POST')  
						...
						<div class="auth-option text-center pt-5">No Account? Sign up <a class="text-link" href="{{ route('signup.page') }}" >here</a>.</div>
